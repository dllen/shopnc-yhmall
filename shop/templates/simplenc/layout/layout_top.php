...
<div class="public-top-layout w">
  <div class="topbar wrapper">  
    ...
    <?php }?><span class="seller-login" style="display:none"><a href="<?php echo urlShop('seller_login','show_login');?>" target="_blank" title="登录商家管理中心"><i class="icon-signin"></i>商家管理中心</a></span></div>
    ...
    <div class="quick-menu">
      ...
      <dl>
        <dt><a href="<?php echo urlShop('article', 'article', array('ac_id' => 6));?>">客户服务</a><i></i></dt>
        <dd>
          <ul>
