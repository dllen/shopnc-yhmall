  ...
  <tbody>
    ...
    <tr>
      <td class="menutd" valign="top" width="161"><div id="mainMenu" class="main-menu">
        ...
        <p>Powered By <em><a href="http://www.cnnewyork.com" target="_blank"><?php echo $GLOBALS['setting_config']['shopnc_version'];?></a></em></p>
        <p>&copy;2007-2014 <a href="http://www.cnnewyork.com/" target="_blank">ShopNC Inc.</a></p></div></td>
